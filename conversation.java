...
public class conversation{
	...
	public void driverMessage(String contents){								//send message from P to D
		...
		while(current.getNext() != null){									//Since driver can't start messages, we have no check
	...
	public void passengerMessage(String contents){							//send message from D to P
		...
		message current = head;			
		if(current == null)													//Since passenger might have first message, checks if message
